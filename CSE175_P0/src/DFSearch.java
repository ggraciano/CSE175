...
// DFSearch
//
// This class implements the breadth-first search algorithm discussed on page
// 85 of Artificial Intelligence: A Modern Approach by Peter Norvig and
// Stuart J. Russell, which uses a strategy that expands the deepest node in
// a search tree and then works its way back up the frontier to find the goal
// node. To complete the assignment, I worked with Ahmed Alhag and the used
// the following resource:
//      https://docs.oracle.com/javase/7/docs/api/java/util/HashSet.html
//
// Gerardo Graciano -- Mon Sept 17 10:47:29 PST 2018
//
