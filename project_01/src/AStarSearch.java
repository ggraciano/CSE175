...
// AStarSearch
//
// This class implements the A* search algorithm discussed on page 93 of
// Artificial Intelligence: A Modern Approach by Peter Norvig and Stuart
// J. Russell, which evaluates nodes by combining g(n), the cost to reach
// the node, and h(n), the cost to get from the node to the goal.To
// complete this assignment, I received help from Jacob Rafati Heravi, in
// which I was redirected to lecture 7 of the slides uploaded.
//
// Gerardo Graciano -- Fri Oct 05 09:20:21 PST 2018
//
...
public class AStarSearch {
	...
	// AStarSearch uses the heuristic function.
	...
	// sortedFrontier sorts by f(n), the sum of g(n), the cost of the path
	// from the start node to n, and h(n), the estimated cost of the cheapest
	// path from n to the goal.
	public SortedFrontier sortedFrontier = new SortedFrontier(SortBy.f);
